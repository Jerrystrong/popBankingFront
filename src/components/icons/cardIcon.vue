<template>
  <svg
    ...
    stroke=""
    class="w-[30px] h-[30px] stroke stroke-lightColor"
  >
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      ></path>
      <path d="M10 16H6" stroke="" stroke-width="1.5" stroke-linecap="round"></path>
      <path d="M14 16H12.5" stroke="" stroke-width="1.5" stroke-linecap="round"></path>
      <path d="M2 10L7 10M22 10L11 10" stroke="" stroke-width="1.5" stroke-linecap="round"></path>
    </g>
  </svg>
</template>
